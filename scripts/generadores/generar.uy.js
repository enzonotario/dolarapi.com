...
const spec = loadJSON('../../docs/public/uruguay/openapi.json')
...
export function init() {
  return Object
    ...
    .map((path) => {
      ...
      fs.writeFileSync(`docs/uruguay/operations/${operationId}.md`, markdown)
    })
}
...
${plantilla(operationId, operation, false, openapi, { openapiUrl: 'https://uy.dolarapi.com/openapi.json' })}
`
