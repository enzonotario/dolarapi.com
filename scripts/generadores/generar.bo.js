...
const spec = loadJSON('../../docs/public/bolivia/openapi.json')
...
export function init() {
  return Object
    ...
    .map((path) => {
      ...
      fs.writeFileSync(`docs/bolivia/operations/${operationId}.md`, markdown)
    })
}
...
${plantilla(operationId, operation, false, openapi, { openapiUrl: 'https://bo.dolarapi.com/openapi.json' })}
`
