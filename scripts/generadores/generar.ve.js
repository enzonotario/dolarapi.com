...
const spec = loadJSON('../../docs/public/venezuela/openapi.json')
...
export function init() {
  return Object
    ...
    .map((path) => {
      ...
      fs.writeFileSync(`docs/venezuela/operations/${operationId}.md`, markdown)
    })
}
...
${plantilla(operationId, operation, false, openapi, { openapiUrl: 'https://ve.dolarapi.com/openapi.json' })}
`
