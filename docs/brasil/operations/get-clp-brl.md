...
<OAOperation :spec="spec" operationId="get-clp-brl" :hide-branding="false">

<template #description="description">

Cotação do peso chileno em reais brasileiros
...
<!--@include: ./parts/get-clp-brl-footer.md -->
...
- `200` — Retorna a cotação do Peso Chileno
