...
## Guía para agentes — Mexico

- Base URL: `https://mx.dolarapi.com`
- Endpoints: `https://mx.dolarapi.com/v1/*`
- OpenAPI (preferir): https://mx.dolarapi.com/openapi.json
- Spec en docs: https://dolarapi.com/docs/mexico/openapi.json
