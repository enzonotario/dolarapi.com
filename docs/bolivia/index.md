---
title: 'API para obtener el precio del Dólar en Bolivia'
description: 'API para Dólar'
aside: false
outline: false

next:
  text: 'Dólar Oficial'
  link: '/bolivia/operations/get-dolar-oficial'
...
head:
  ...
  - [
    ...
    {
      property: 'og:title',
      content: 'API para obtener el precio del Dólar en Bolivia',
    },
  ]
  - [
    'meta',
  ...
  - ['meta', { property: 'twitter:description', content: 'API de cotizaciones de monedas extranjeras en Bolivia' }]
  - ['meta', { property: 'twitter:title', content: 'API para obtener el precio del Dólar en Bolivia' }]
...
# DolarApi.com <small class="ml-2 text-sm">Región <span class="bg-indigo-100 text-indigo-800 dark:bg-indigo-800 dark:!text-indigo-50 px-2 py-1 rounded-md">Bolivia</span></small>

API desarrollada en [EsJS](https://es.js.org?ref=dolarapi.com) que brinda información actualizada sobre las cotizaciones de monedas extranjeras en Bolivia.
