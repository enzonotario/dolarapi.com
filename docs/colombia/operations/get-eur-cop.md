...
<OAOperation :spec="spec" operationId="get-eur-cop" :hide-branding="false">

<template #description="description">

Cotización del euro en pesos colombianos
...
<!--@include: ./parts/get-eur-cop-footer.md -->
...
- `200` — Retorna la cotización del Euro
