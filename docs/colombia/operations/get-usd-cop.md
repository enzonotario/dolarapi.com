...
<OAOperation :spec="spec" operationId="get-usd-cop" :hide-branding="false">

<template #description="description">

Cotización del dólar americano en pesos colombianos
...
<!--@include: ./parts/get-usd-cop-footer.md -->
...
- `200` — Retorna la cotización del Dólar
