...
<OAOperation :spec="spec" operationId="get-mxn-cop" :hide-branding="false">

<template #description="description">

Cotización del peso mexicano en pesos colombianos
...
<!--@include: ./parts/get-mxn-cop-footer.md -->
...
- `200` — Retorna la cotización del Peso Mexicano
