...
aside: false
outline: false
title: Histórico Dólar Paralelo por Fecha
head:
  - [
    'meta',
    {
...
<OAOperation :spec="spec" operationId="get-historicos-dolar-paralelo-fecha" :hide-branding="false">
...
<!--@include: ./parts/get-historicos-dolar-paralelo-fecha-footer.md -->
...
## GET /v1/historicos/dolares/paralelo/{fecha}

Histórico Dólar Paralelo por Fecha
