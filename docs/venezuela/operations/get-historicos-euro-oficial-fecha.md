...
aside: false
outline: false
title: Histórico Euro Oficial por Fecha
head:
  - [
    'meta',
    {
...
<OAOperation :spec="spec" operationId="get-historicos-euro-oficial-fecha" :hide-branding="false">

<template #description="description">

Devuelve la cotización del Euro Oficial para una fecha específica (en formato `YYYY/MM/DD`)
...
<!--@include: ./parts/get-historicos-euro-oficial-fecha-footer.md -->
...
## GET /v1/historicos/euros/oficial/{fecha}

Histórico Euro Oficial por Fecha
