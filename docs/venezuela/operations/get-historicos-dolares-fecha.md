...
aside: false
outline: false
title: Histórico Dólares por Fecha
head:
  - [
    'meta',
    {
...
<OAOperation :spec="spec" operationId="get-historicos-dolares-fecha" :hide-branding="false">
...
<!--@include: ./parts/get-historicos-dolares-fecha-footer.md -->
