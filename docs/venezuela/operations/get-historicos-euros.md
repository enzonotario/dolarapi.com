...
<OAOperation :spec="spec" operationId="get-historicos-euros" :hide-branding="false">

<template #description="description">

Devuelve el último valor de cada día para Euro oficial y paralelo, ordenados por fecha
...
<!--@include: ./parts/get-historicos-euros-footer.md -->
