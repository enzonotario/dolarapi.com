...
aside: false
outline: false
title: Histórico Euro Paralelo por Fecha
head:
  - [
    'meta',
    {
...
<OAOperation :spec="spec" operationId="get-historicos-euro-paralelo-fecha" :hide-branding="false">

<template #description="description">

Devuelve la cotización del Euro Paralelo para una fecha específica (en formato `YYYY/MM/DD`)
...
<!--@include: ./parts/get-historicos-euro-paralelo-fecha-footer.md -->
...
## GET /v1/historicos/euros/paralelo/{fecha}

Histórico Euro Paralelo por Fecha
