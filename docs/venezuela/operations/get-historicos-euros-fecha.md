...
aside: false
outline: false
title: Histórico Euros por Fecha
head:
  - [
    'meta',
    {
...
<OAOperation :spec="spec" operationId="get-historicos-euros-fecha" :hide-branding="false">
...
<!--@include: ./parts/get-historicos-euros-fecha-footer.md -->
...
## GET /v1/historicos/euros/{fecha}

Histórico Euros por Fecha
