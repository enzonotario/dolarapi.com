...
## Guía para agentes — Venezuela

- Base URL: `https://ve.dolarapi.com`
- Endpoints: `https://ve.dolarapi.com/v1/*`
- OpenAPI (preferir): https://ve.dolarapi.com/openapi.json
- Spec en docs: https://dolarapi.com/docs/venezuela/openapi.json
