---
title: 'API para obtener el precio del Dólar en Uruguay'
...
head:
  - [
    ...
    {
      name: 'description',
      content: 'API de cotizaciones de monedas extranjeras en Uruguay',
    },
  ]
  - [
    'meta',
  ...
  - [
    ...
    {
      property: 'og:title',
      content: 'API para obtener el precio del Dólar en Uruguay',
    },
  ]
  - [
    'meta',
  ...
  - ['meta', { property: 'twitter:description', content: 'API de cotizaciones de monedas extranjeras en Uruguay' }]
  - ['meta', { property: 'twitter:title', content: 'API para obtener el precio del Dólar en Uruguay' }]
...
# DolarApi.com <small class="ml-2 text-sm">Región <span class="bg-indigo-100 text-indigo-800 dark:bg-indigo-800 dark:!text-indigo-50 px-2 py-1 rounded-md">Uruguay</span></small>

API desarrollada en [EsJS](https://es.js.org?ref=dolarapi.com) que brinda información actualizada sobre las cotizaciones de monedas extranjeras en Uruguay.
...
## Guía para agentes — Uruguay

- Base URL: `https://uy.dolarapi.com`
- Endpoints: `https://uy.dolarapi.com/v1/*`
- OpenAPI (preferir): https://uy.dolarapi.com/openapi.json
- Spec en docs: https://dolarapi.com/docs/uruguay/openapi.json
